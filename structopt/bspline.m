function [B,U] = bspline(p,U,u)

%BSPLINE   B-spline basis functions.
%
%   [B,U] = BSPLINE(p,[],u) evaluates the p-th degree Bezier spline basis
%   functions at the free parameter values u.
%
%   [B,U] = BSPLINE(p,N,u), where N>p is a scalar, evaluates the p-th degree
%   B-spline basis functions with N control vertices and a uniform knot vector
%   at the free parameter values u.
%
%   [B,U] = BSPLINE(p,U,u), where U is a vector of length > 1, evaluates the
