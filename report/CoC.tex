...
\section*{Code of conduct and transparency statement on the use of GenAI for KU Leuven-students (academic year 2025--2026)}
...
\textbf{Student name:} & Lukas Campaert    & \textbf{Student number:} & r0885501 \\
\textbf{Student name:} & Tiebert Lefebure  & \textbf{Student number:} & r0887630 \\
\end{tabularx}
...
\noindent
\colorbox{lightgray}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\textbf{Course assignment information:}}}

\vspace{1em}

\textbf{X} This form is related to a \textbf{course assignment.}

\begin{tabularx}{\linewidth}{@{}lXlX@{}}
\textbf{Course name:} & Structural Optimization & \textbf{Course number:} & B-KUL-H0T88A \\
\end{tabularx}
...
\textbf{X} I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): ChatGPT
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & ChatGPT. Used to proofread paragraphs we wrote ourselves: catching typos, fixing grammar, and flagging awkward or Dutchified phrasings (literal Dutch-to-English constructions that read unnaturally in technical English). All edits were reviewed and rewritten by us before being kept. & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text.
...
\end{itemize} \\ \hline
\textbf{As a search engine to get information on a topic or to search for existing research on the topic} & ChatGPT. Used as an initial aid to clarify how sensitivity verification is discussed in structural optimization; all information was checked against course material and cited sources before use. & This use is similar to e.g. a Google search or checking Wikipedia. If you write your own text based on this information, you do not have to refer to the use of GenAI in the text. \textbf{You only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the existing research and references you have checked and used }(without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For literature search} & No. & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
} & No. & According to Article 84 of the Regulations on Education and Examinations your text should allow to correctly and properly assess your own knowledge, understanding and skills. \textbf{Therefore, inserting blocks of text without quotes and a reference to GenAI assistance in your work is not allowed. }
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & ChatGPT. Used to help generate supporting figures for theory, such as the MMA graph, and to visualize data obtained from our own simulations, such as the time-reduction comparison. & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study.
