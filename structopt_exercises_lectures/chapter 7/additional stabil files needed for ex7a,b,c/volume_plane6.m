function [V,dVdx] = volume_plane6(Node,Section,dNodedx,dSectiondx)

% VOLUME_PLANE6   Compute the volume of a plane6 element.
%
%   V = VOLUME_PLANE6(Node,Section) computes the volume of a plane6 element.
%
%   [V,dVdx] = VOLUME_PLANE6(Node,Section,dNodedx,dSectiondx) computes the
%   volume of a plane6 element, as well as the derivatives of the
...
if nargout==1
  ...
  [S,dSdx] = size_plane6(Node,dNodedx);
  V = h*S;
  dVdx = h.*dSdx + dhdx.*S;
end
