function [V,dVdx] = volume_plane3(Node,Section,dNodedx,dSectiondx)

% VOLUME_PLANE3   Compute the volume of a plane3 element.
%
%   V = VOLUME_PLANE3(Node,Section) computes the volume of a plane3 element.
%
%   [V,dVdx] = VOLUME_PLANE3(Node,Section,dNodedx,dSectiondx) computes the
%   volume of a plane3 element, as well as the derivatives of the
...
if nargout==1
  ...
  [S,dSdx] = size_plane3(Node,dNodedx);
  V = h*S;
  dVdx = h.*dSdx + dhdx.*S;
end
