...
%   entrance height and the center height.
...
while true
  ...
  f0 = C;
  f = [V/Vmax-1; zA/zAmax-1; 1-zB/zBmin; 1-zC/zCmin];
  ...
  if iter==1 || (f0<=subp.f0e && all(f<=subp.fe))
    ...
    df0dx = dCdx;
    dfdx = [dVdx/Vmax; dzAdx/zAmax; -dzBdx/zBmin; -dzCdx/zCmin];
  end
