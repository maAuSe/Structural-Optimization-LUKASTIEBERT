function [SeGCS,SeLCS,vLCS] = se_solid8(Node,Section,Material,UeGCS,Options,gcs)
...
for iGauss=1:nXi
    ...
    [Ni,dNi_dxi,dNi_deta,dNi_dzeta] = sh_vs8(xi(iGauss,1),xi(iGauss,2),xi(iGauss,3));
