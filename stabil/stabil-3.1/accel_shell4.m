function DLoads=accel_shell4(Accelxyz,Nodes,Elements,Sections,Materials,Options)
...
for iElem=1:nElem
    ...
    DLoads(iElem,:)=[Elements(iElem,1) -Accelxyz*rho*h(1) -Accelxyz*rho*h(1) -Accelxyz*rho*h(1) -Accelxyz*rho*h(1)];
