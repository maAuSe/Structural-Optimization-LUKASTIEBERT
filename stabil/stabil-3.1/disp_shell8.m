function [Ax,Ay,Az,B,Cx,Cy,Cz,dAxdx,dAydx,dAzdx,dCxdx,dCydx,dCzdx]=disp_shell8(Nodes,Elements,DOF,EltIDDLoad,Sections,Materials,nPoints,dNodesdx,dDLoadsdx,dSectionsdx)
...
Nx = sparse(4*nPoints+1,24);
Ny = sparse(4*nPoints+1,24);
Nz = sparse(4*nPoints+1,24);
